...
const PlaceOrder = () => {
  ...
  return (
    <div className='flex flex-col sm:flex-row justify-center gap-28 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      <div className='flex flex-col gap-4 w-full sm:max-w-[480px]'>
        ...
        <div className='flex gap-3'>
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Quận'/>
          <input className='border border-gray-300 rounded py-1.5 px-3.5 w-full' type="text" placeholder='Thành phố'/>
        </div>
        <textarea className='border border-gray-300 rounded py-1.5 px-3.5 w-full' name="" id="" placeholder='Ghi chú'>
      ...
      <div className='mt-8'>
        ...
        <div className='mt-7'>
          ...
          <div className='w-full text-center mt-8'>
            <button onClick={() => navigate('/orders')} className='bg-black text-white px-16 py-3 text-sm w-full'>ĐẶT HÀNG</button>
          </div>
        </div>
      </div>
    </div>
