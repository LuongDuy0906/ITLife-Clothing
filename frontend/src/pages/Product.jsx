    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <p className='mt-5 text-3xl font-medium'>{productData.price.toLocaleString()}{currency}</p>
          ...
          <button onClick={() => addToCart(productData._id, size)} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700'>Thêm giỏ hàng</button>
          <hr className='mt-8 sm:w-4/5'/>
          <div className='text-sm text-gray-500 mt-5 flex flex-col gap-1'>
              <p>100% Sản phẩm chính hãng</p>
              <p>Áp dụng thanh toán khi nhận hàng</p>
